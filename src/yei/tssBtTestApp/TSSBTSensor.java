...
public class TSSBTSensor{
	...
	protected TSSBTSensor() throws Exception{
        ...
        if (pairedDevices.size() > 0) {
            for (BluetoothDevice device : pairedDevices) {
            	...
            	System.out.println("deviceNames"+device.getName());
            	Log.i(TAG,"Device"+device.getName());
            	if(device.getName().contains("FireFly-4577"))
            	{
            		Log.i(TAG,"here");
    ...
    public float[] getNormalizedAccelerometer()
    {
    	call_lock.lock();
    ...
    public float[] getCorrectedAccelerometer()
    {
    	call_lock.lock();
    	byte[] send_data = new byte[]{(byte)0x27};
    	write(send_data);
    	byte[] response = read(12);
    	call_lock.unlock();
    	return binToFloat(response);	
    ...
    public float[] getRawAccelerometer()
    {
    	call_lock.lock();
    	byte[] send_data = new byte[]{(byte)0x42};
    	write(send_data);
    	byte[] response = read(12);
    	call_lock.unlock();
    	return binToFloat(response);	
    ...
    public float[] getNormalizedGyro()
    {
    	call_lock.lock();
    ...
    {
    	call_lock.lock();
    	byte[] send_data = new byte[]{(byte)0x26};
    	write(send_data);
    	byte[] response = read(12);
    	call_lock.unlock();
    	return binToFloat(response);	
    ...
    {
    	call_lock.lock();
    	byte[] send_data = new byte[]{(byte)0x41};
    	write(send_data);
    	byte[] response = read(12);
    	call_lock.unlock();
    	return binToFloat(response);	
    ...
    public float[] getNormalizedCompass()
    {
    	call_lock.lock();
    	byte[] send_data = new byte[]{(byte)0x23};
    	write(send_data);
    	byte[] response = read(12);
    	call_lock.unlock();
    	return binToFloat(response);	
    ...
    {
    	call_lock.lock();
    	byte[] send_data = new byte[]{(byte)0x28};
    	write(send_data);
    	byte[] response = read(12);
    	call_lock.unlock();
    	return binToFloat(response);	
    ...
    {
    	call_lock.lock();
    	byte[] send_data = new byte[]{(byte)0x43};
    	write(send_data);
    	byte[] response = read(12);
    	call_lock.unlock();
    	return binToFloat(response);	
